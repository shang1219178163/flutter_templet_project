//
//  DbStudentController.dart
//  flutter_templet_project
//
//  Created by shang on 2024/2/24 09:37.
...
class DBStudentController<E extends DBStudent> extends GetxController{
  DBStudentController() {
    init();
  }
  ...
  Future<void> update([List<Object>? ids, bool condition = true]) async {
    if (!Get.isRegistered<DBStudentController>()) {
      return;
    }
