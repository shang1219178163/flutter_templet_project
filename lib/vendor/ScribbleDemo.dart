...
class _ScribbleDemoState extends State<ScribbleDemo> {
  ...
  //           height: 20.0,
  //         ),
  //         _buildPointerModeSwitcher(context, penMode: state.allowedPointersMode == ScribblePointerMode.penOnly),
  //         const Divider(
  //           height: 20.0,
  //         ),
  ...
  Widget buildColorButton(
    ...
    final argb = ((color.a * 255).round() << 24) |
        ...
        ((color.g * 255).round() << 8) |
        (color.b * 255).round();
    final isSelected = state is Drawing && state.selectedColor == argb;
    return Padding(
      padding: const EdgeInsets.all(4),
      child: FloatingActionButton.small(
