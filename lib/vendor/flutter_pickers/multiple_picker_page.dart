...
class _MultiplePickerPageState extends State<MultiplePickerPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('多列选择器')),
  ...
  void _onClickItem() {
    ...
    Widget _headMenuView = Container(
        ...
        height: menuHeight,
        child: Row(children: [
          Expanded(child: Center(child: NText('时'))),
          Expanded(child: Center(child: NText('分'))),
        ]));
  ...
  void _onClickItem2() {
    ...
    Widget _headMenuView = Container(
        ...
        height: menuHeight,
        child: Row(children: [
          Expanded(child: Center(child: NText('早晚'))),
          Expanded(child: Center(child: NText('时'))),
          Expanded(child: Center(child: NText('分'))),
          Expanded(child: Center(child: NText('秒'))),
        ]));
  ...
  void _onClickItem4() {
    ...
    Widget title =
        Center(child: NText('自定义选择器', color: Colors.white, fontSize: 14));
