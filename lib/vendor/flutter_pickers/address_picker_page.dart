...
class _AddressPickerPageState extends State<AddressPickerPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('地址选择器')),
      body: Padding(
  ...
  Widget _checkLocation3() {
    ...
    Widget _headMenuView = Container(
        ...
        height: menuHeight,
        child: Row(children: [
          Expanded(child: Center(child: NText('省', color: Colors.white))),
          Expanded(child: Center(child: NText('市', color: Colors.white))),
          Expanded(child: Center(child: NText('区', color: Colors.white))),
        ]));
    ...
    Widget _cancelButton = Container(
      ...
      child: NText('取消', color: Colors.white, fontSize: 14),
    );
    ...
    Widget _commitButton = Container(
      ...
      decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(4)),
      child: NText('确认', color: Colors.white, fontSize: 14),
    );
    ...
    Widget title =
        Center(child: NText('请选择地址', color: Colors.white, fontSize: 14));
