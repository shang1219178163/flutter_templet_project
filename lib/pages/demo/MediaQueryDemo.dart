...
class _MediaQueryDemoState extends State<MediaQueryDemo>
  ...
  void onKeyboardChanged(bool visible) {
    ...
    debugPrint(
        "onKeyboardChanged:${visible ? "展开键盘" : "收起键盘"} ${context.viewBottom}");
...
显示键盘: padding: EdgeInsets(0.0, ${mediaQuery.padding.top}, 0.0, 0.0)
  ...
  final items = [
    ...
    Tuple2("viewPadding",
        "被系统遮挡的部分，通常指“刘海屏”或者系统状态栏，此值独立于padding和viewInsets，它们的值从MediaQuery控件边界的边缘开始测量。在移动设备上，通常是全屏。"),
    Tuple2("systemGestureInsets",
