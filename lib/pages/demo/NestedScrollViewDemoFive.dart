...
class _NestedScrollViewDemoFiveState extends State<NestedScrollViewDemoFive> with SingleTickerProviderStateMixin {
  ...
  @override
  void initState() {
    scrollController.addListener(onScrollerLtr);
    super.initState();
  }

  onScrollerLtr() {
    scrollY.value = scrollController.offset;
    // scrollProgress.value = scrollController.position.progress;
  }
