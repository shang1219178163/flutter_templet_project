...
var list = <Tuple2<String, String>>[
  ...
  Tuple2(AppRouter.tabContainerDemo, "TabContainer"),
  ...
  Tuple2(AppRouter.afterLayoutDemo, "afterLayoutDemo"),
  ...
  Tuple2(AppRouter.callbackShortcutsDemo, "callbackShortcutsDemo"),
  ...
  Tuple2(AppRouter.nWrapPageViewDemo, "NWrapPageView 分页"),
  ...
  Tuple2(AppRouter.menuBarDemo, "MenuBarDemo"),
...
var specials = <Tuple2<String, String>>[
  ...
  Tuple2(AppRouter.animatedContainerExample, "animatedContainerExample"),
...
var customs = [
  ...
  Tuple2(AppRouter.aiChatPage, "AI 流式对话"),
  ...
  Tuple2(AppRouter.selectListDemo, "selectListDemo"),
...
var vendors = <Tuple2<String, String>>[
  ...
  Tuple2(AppRouter.gameMatchPage, "gameMathPage"),
  Tuple2(AppRouter.gameMatchPageNew, "GameMathPageNew"),
  ...
  Tuple2(AppRouter.colorOpacityCompareDemo, "colorOpacityCompareDemo"),
  ...
  Tuple2(AppRouter.pageRouteAnimationDemo, "页面路由动画"),
