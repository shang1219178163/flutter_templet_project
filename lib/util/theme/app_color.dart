...
class AppColor {
  ...
  static const Color fontColor181818 = Color(0xff181818);
  static const Color fontColorBCBFC2 = Color(0xffBCBFC2);
  static const Color fontColor333333 = Color(0xff333333);
  static const Color fontColor5D6D7E = Color(0xff5D6D7E);
  static const Color fontColor666666 = Color(0xff666666);
  static const Color fontColor737373 = Color(0xff737373);
  static const Color fontColor777777 = Color(0xff777777);
  static const Color fontColor999999 = Color(0xff999999);
  static const Color fontColorB3B3B3 = Color(0xffB3B3B3);
  static const Color fontColorF9F9F9 = Color(0xffF9F9F9);

  ///背景色 #F3F3F3
  static const Color bgColor = Color(0xffF3F3F3);
  static const Color bgColorEDEDED = Color(0xffEDEDED);
  static const Color bgColorF3F3F3 = Color(0xffF3F3F3);
  static const Color bgColorF7F7F7 = Color(0xFFF7F7F7);
