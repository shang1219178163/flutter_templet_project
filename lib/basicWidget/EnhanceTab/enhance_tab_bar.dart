...
// upon layout. The tab widths are only used at paint time (see _EnhanceIndicatorPainter)
...
class _EnhanceIndicatorPainter extends CustomPainter {
  ...
  Rect indicatorRect(Size tabBarSize, int tabIndex) {
    ...
    Rect rect = Rect.fromLTWH(tabLeft, 0.0, tabRight - tabLeft, tabBarSize.height);
...
class _EnhanceTabBarState extends State<EnhanceTabBar> {
  ...
  void _initIndicatorPainter() {
    _indicatorPainter = !_controllerIsValid ? null : _EnhanceIndicatorPainter(
