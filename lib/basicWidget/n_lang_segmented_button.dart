...
import 'package:flutter_templet_project/basicWidget/n_segmented_button.dart';
...
/// 可嵌入的中英切换控件。
class NLangSegmentedButton extends StatelessWidget {
  const NLangSegmentedButton({
    super.key,
    required this.value,
  ...
  Widget build(BuildContext context) {
    return NSegmentedButton<NLangEnum>(
