...
class EnBoxDecoration extends Decoration {
  ...
  EnBoxDecoration scale(double factor) {
    return EnBoxDecoration(
  ...
  Decoration? lerpFrom(Decoration? a, double t) => switch (a) {
        null => scale(t),
        EnBoxDecoration() => EnBoxDecoration.lerp(a, this, t),
        _ => super.lerpFrom(a, t) as BoxDecoration?
      };

  @override
  Decoration? lerpTo(Decoration? b, double t) => switch (b) {
        null => scale(1.0 - t),
        EnBoxDecoration() => EnBoxDecoration.lerp(this, b, t),
  ...
  static EnBoxDecoration? lerp(EnBoxDecoration? a, EnBoxDecoration? b, double t) {
    if (identical(a, b)) {
      return a;
    }
    if (a == null) {
...
class _BoxDecorationPainter extends BoxPainter {
  ...
  final EnBoxDecoration _decoration;
  ...
  double _calculateAdjustedSide(BorderSide side) {
    if (side.color.a == 1.0 && side.style == BorderStyle.solid) {
