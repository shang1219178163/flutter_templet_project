...
class EnExpansionTile extends StatefulWidget {
  ...
  ///
  /// If this property is null then [EnhanceExpansionTileThemeData.backgroundColor] is used. If that
  /// is also null then Colors.transparent is used.
  ///
  /// See also:
  ///
  /// * [EnhanceExpansionTileTheme.of], which returns the nearest [EnhanceExpansionTileTheme]'s
  ///   [EnhanceExpansionTileThemeData].
  final Color? backgroundColor;

  /// When not null, defines the background color of tile when the sublist is collapsed.
  ///
  /// If this property is null then [EnhanceExpansionTileThemeData.collapsedBackgroundColor] is used.
  ...
  ///
  /// If this property is null then [EnhanceExpansionTileThemeData.tilePadding] is used. If that
  ...
  ///
  /// If this property is null then [EnhanceExpansionTileThemeData.expandedAlignment]is used. If that
  ...
  ///
  /// If this property is null then [EnhanceExpansionTileThemeData.childrenPadding] is used. If that
  ...
  ///
  /// If this property is null then [EnhanceExpansionTileThemeData.textColor] is used. If that
  ...
  /// Used to override to the [ListTileThemeData.textColor].
  ///
  /// If this property is null then [EnhanceExpansionTileThemeData.collapsedTextColor] is used. If that
  /// is also null then the value of [ListTileThemeData.textColor] is used.
  ///
  /// See also:
  ///
    ...
    return ClipRRect(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            widget.header?.call(_isExpanded, _handleTap) ??
                ListTileTheme.merge(
