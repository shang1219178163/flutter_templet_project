...
/// 键盘辅助视图
class NInputAccessoryViewNew extends StatefulWidget {
  const NInputAccessoryViewNew({
    super.key,
    this.focusNode,
  ...
  @override
  State<NInputAccessoryViewNew> createState() => _NInputAccessoryViewNewState();
}

class _NInputAccessoryViewNewState extends State<NInputAccessoryViewNew>
    with KeyboardHeightChangedMixin<NInputAccessoryViewNew> {
  @override
  Widget build(BuildContext context) {
    final textField = TextField(
      onTapOutside: (e) {
        ...
        NInputAccessoryViewNew.dismiss();
      },
